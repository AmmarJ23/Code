...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Create a student
        Student s1 = new Student("Waffi Qayyum", "A001");
        Student s2 = new Student("Amarul Akmal", "A002");
        studentList.add(s1);
        studentList.add(s2);

        //Create lecturers
        Lecturer l1 = new Lecturer("Dr. Sarah Afiz", "S001");
        Lecturer l2 = new Lecturer("Dr. Harris Farhan ", "S002");
        lecturerList.add(l1);
        lecturerList.add(l2);

        //Create Academic Officers
        AcademicOfficer a1 = new AcademicOfficer("Academic Officer", "S101");
        acadList.add(a1);
